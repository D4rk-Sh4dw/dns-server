...
The script will auto-detect your installation directory. If it can't find it, you'll be prompted to enter the path interactively. You can also specify it upfront:
